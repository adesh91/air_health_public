...
#df12=pd.read_excel('numbers_for _figures.xlsx',sheet_name= "Figure2b") #income
...
plt.scatter(d1, y111d1, marker='o', facecolors='white', color='darkorange', zorder=2, label=' ')
#plt.scatter(x11, y111x11, marker='o', facecolors='white', color='deepskyblue', zorder=2)
plt.scatter(x1, y111x1, marker='o', facecolors='white', color='darkorange', zorder=2)
#plt.scatter(x33, y111x33, marker='o', facecolors='white', color='deepskyblue', zorder=2)
plt.scatter(x4, y111x4, marker='o', facecolors='white', color='darkorange', zorder=2)
plt.scatter(x3, y111x3, marker='o', facecolors='white', color='darkorange', zorder=2)
plt.scatter(x2, y111x2, marker='o', facecolors='white', color='darkorange', zorder=2)
...
#plt.scatter(d2, y111d2, marker='o', color='darkorange', zorder=2)
plt.scatter(d1, y111d1, marker='o', color='darkorange', zorder=2, label='Percent white population')
#plt.scatter(x11, y111x11, marker='o', color='deepskyblue', zorder=2)
plt.scatter(x1, y111x1, marker='o', color='darkorange', zorder=2)
#plt.scatter(x33, y111x33, marker='o', color='deepskyblue', zorder=2)
plt.scatter(x4, y111x4, marker='o', color='darkorange', zorder=2)
plt.scatter(x3, y111x3, marker='o', color='darkorange', zorder=2)
plt.scatter(x2, y111x2, marker='o', color='darkorange', zorder=2)
...
#plt.text(-0.2, 1.0, 'b)', transform=plt.gca().transAxes, fontsize=10)
#plt.text(0.4, 1.0, 'PM$_{{2.5}}$', transform=plt.gca().transAxes, fontsize=10)
#plt.xlabel('μg$/$m$^{-3}$', fontdict=None, labelpad=None, loc='center')
plt.savefig('Figure4_PM2.5_race_N_NR_legend.svg', bbox_inches='tight', dpi=1000)
plt.show()
