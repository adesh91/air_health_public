...
#plt.scatter(d2, y111d2, marker='o', color='darkorange', zorder=2)
plt.scatter(d1, y111d1, marker='o', color='deepskyblue', zorder=2, label='Percent white population')
#plt.scatter(x11, y111x11, marker='o', color='deepskyblue', zorder=2)
...
plt.savefig('Figure4_PM2.5_income_N_NR.svg', bbox_inches='tight', dpi=1000)
plt.show()
