...
# 1.读取Excel文件
df = pd.read_excel('PM25_O3_color.xlsx', sheet_name='R50-17Jul', usecols=['A', 'B', 'C'])
...
#ax.set_title('REF2050 - 2017 (summer O3)', fontsize=10)

# 保存图表为图像文件
plt.savefig('PM25_O3_color_R50-17Jul.png', bbox_inches='tight', dpi=1000)
