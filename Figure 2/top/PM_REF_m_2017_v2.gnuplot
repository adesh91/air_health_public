...
set output "PM_REF2050_m_2017_v2.ps"
...
set cbrange [-4:4]
set cbtics font ",12" 
set title "2050 Reference - 2017" font ",12"
set ylabel "PM_2_._5 ({/Symbol m}g/m^3)" font ",12"
set ylabel offset -1,0,0 
set label "Populated-weighted exposure: 6.6 {/Symbol m}g/m^3 (REF2050)" at graph 0.5,-0.1 center font ",12"
splot [1:456][1:296] "wrfout.pm25_year_REF2050_m_2017"matrix notitl 
