...
set output "PM_NZ2050_m_2017_v2.ps"
...
set cbrange [-4:4]
set cbtics font ",12" 
set title "2050 Net-zero - 2017" font ",12"
set ylabel "PM_2_._5 ({/Symbol m}g/m^3)" font ",12"
set ylabel offset -1,0,0 
set label "Populated-weighted exposure: 6.0 {/Symbol m}g/m^3 (NZ2050)" at graph 0.5,-0.1 center font ",12"
splot [1:456][1:296] "wrfout.pm25_year_NZ2050_m_2017"matrix notitl 
